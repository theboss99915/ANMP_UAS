...
class CategoryListAdapter(val foodList:ArrayList<Food>)
    : RecyclerView.Adapter<CategoryListAdapter.CategoryListHolder>()
{
    class CategoryListHolder(var view: View) : RecyclerView.ViewHolder(view)
    ...
    override fun onBindViewHolder(holder: CategoryListHolder, position: Int) {
        ...
        btnDetailUK.setOnClickListener {
            val action = CategoryListDirections.actionCategoryListToUbayaKulinerDetail(foodList[position].id.toString())
